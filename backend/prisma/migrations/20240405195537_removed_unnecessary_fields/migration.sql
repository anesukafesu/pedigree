/*
  ...
  - You are about to drop the column `temperament_rating` on the `Breed` table. All the data in the column will be lost.
...
INSERT INTO "new_Breed" ("animal_id", "annual_fertility_rate", "breed_name", "daily_feed_requirement", "daily_water_requirement", "id", "max_temp_requirement", "min_temp_requirement", "supplier_id") SELECT "animal_id", "annual_fertility_rate", "breed_name", "daily_feed_requirement", "daily_water_requirement", "id", "max_temp_requirement", "min_temp_requirement", "supplier_id" FROM "Breed";
DROP TABLE "Breed";
