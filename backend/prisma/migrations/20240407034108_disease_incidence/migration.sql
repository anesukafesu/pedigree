/*
  ...
  - You are about to drop the column `likelihoodId` on the `BreedDisease` table. All the data in the column will be lost.
  - Added the required column `diseases_incidence_likelihood_id` to the `BreedDisease` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_BreedDisease" ("breed_id", "disease_id", "id", "precaution", "treatment") SELECT "breed_id", "disease_id", "id", "precaution", "treatment" FROM "BreedDisease";
